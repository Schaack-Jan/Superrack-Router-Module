...
function helperExePath(instance) {
	...
	return path.join(__dirname, '..', ...HELPER_DEFAULT_RELATIVE)
}
...
function _startHelperBackend(instance) {
	...
	if (!fs.existsSync(exePath)) {
		instance._log('warn', 'MIDI service: Windows MIDI Services helper not found, falling back to loopMIDI backend', {
			exePath,
		})
